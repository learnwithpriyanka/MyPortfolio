...
export default function ProjectsSection() {
  ...
  const projects = [
    {
      id: 1,
      title: 'Innovience Platform',
      category: 'Web Apps',
      description: 'Modern innovation platform with React and Next.js for streamlined project management and collaboration',
